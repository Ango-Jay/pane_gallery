...
const Navbar = ({ darkTheme }: { darkTheme: boolean }) => {
  return (
    ...
    >
      <nav className="container mx-auto px-6 sm:px-10">
        <div className="flex items-center text-white">
          <a
            href="#"
            className="font-bold text-base xs:text-xl text-dark-blue uppercase h-[36px] flex items-center relative pl-[4.1rem] xs:pl-[5.1rem]"
          >
