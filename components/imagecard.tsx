    ...
    <>
      <div
        ...
        className={classnames(
          "relative w-full cursor-pointer overflow-hidden h-[282px] max-h-[473px] shadow-lg  transition-all duration-300 sm:hover:scale-[1.05] sm:hover:z-[5] sm:hover:max-h-none group",
